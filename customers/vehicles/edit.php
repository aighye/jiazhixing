...
$id = (int)($_GET['id'] ?? 0);
$vehicle = $db->fetchOne("SELECT * FROM customer_vehicles WHERE id = ?", [$id]);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['plate_number'])) {
        ...
        if ($data['is_default']) {
            $db->update('customer_vehicles', ['is_default' => 0], 'customer_id = ? AND id != ?', [$vehicle['customer_id'], $id]);
        }
        $db->update('customer_vehicles', $data, 'id = ?', [$id]);
        Logger::log('编辑车辆', "修改车辆: {$data['plate_number']}", 'customers');
        Helper::redirect('/customers/view.php?id=' . $vehicle['customer_id']);
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>编辑车辆 - 汽车4S店维修业务管理系统</title>
            ...
            <div class="col-md-10 main-content">
                ...
                <div class="p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <a href="/customers/view.php?id=<?php echo $vehicle['customer_id']; ?>" class="btn btn-outline-secondary btn-sm me-2"><i class="bi bi-arrow-left"></i> 返回</a>
                            <span class="h3">编辑车辆</span>
                        </div>
                    </div>
                            ...
                            <form method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="brand" class="form-control" value="<?php echo htmlspecialchars($vehicle['brand'] ?? ''); ?>">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="vin" class="form-control" value="<?php echo htmlspecialchars($vehicle['vin'] ?? ''); ?>">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">发动机号</label>
                                        <input type="text" name="engine_no" class="form-control" value="<?php echo htmlspecialchars($vehicle['engine_no'] ?? ''); ?>">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" name="displacement" class="form-control" value="<?php echo htmlspecialchars($vehicle['displacement'] ?? ''); ?>">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">当前里程(km)</label>
                                        <input type="number" name="mileage" class="form-control" value="<?php echo $vehicle['mileage']; ?>">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="date" name="registration_date" class="form-control" value="<?php echo $vehicle['registration_date'] ?? ''; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">保险到期日</label>
                                        <input type="date" name="insurance_date" class="form-control" value="<?php echo $vehicle['insurance_date'] ?? ''; ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">年检到期日</label>
                                        <input type="date" name="inspection_date" class="form-control" value="<?php echo $vehicle['inspection_date'] ?? ''; ?>">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">备注</label>
                                    <textarea name="remark" class="form-control" rows="3"><?php echo htmlspecialchars($vehicle['remark'] ?? ''); ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="is_default" id="is_default" <?php echo $vehicle['is_default'] ? 'checked' : ''; ?>>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="/customers/view.php?id=<?php echo $vehicle['customer_id']; ?>" class="btn btn-outline-secondary">取消</a>
                                </div>
                            </form>
                        </div>
                    </div>
